...
- [x] 1.1 Add a translucent neutral-grey background to the existing interval
...
- [x] 2.1 After the production CSS is in place, extend the workstation
      presentation test to prove the veil has a translucent grey background,
...
- [ ] 3.1 Confirm in the running desk that the chart is visibly greyed while
