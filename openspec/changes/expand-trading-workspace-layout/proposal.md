...
- `futures-workstation-presentation`: Require the desktop workstation to consume available width, remain inside the viewport, and avoid page-level horizontal scrolling.

## Impact

- Affects the Futures page shell in `src/styles/app-layout.css` and its presentation tests.
