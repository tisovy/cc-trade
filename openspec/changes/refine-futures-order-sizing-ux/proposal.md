...
- Add a separate compact percentage slider to the shortcut confirmation popup so the staged order can be resized before `Send`; keep the working-order editor slider in place.
