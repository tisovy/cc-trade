...
- [ ] 3.3 Operator confirms on the running desk that the rail follows the confirmation slider, and that a resting order no longer hides the candles at its price.
