...
- [ ] 6.3 Operator confirms on live data: opening a contract shows deep history, scrolling left keeps loading, and a restart loads the same history without a request.
