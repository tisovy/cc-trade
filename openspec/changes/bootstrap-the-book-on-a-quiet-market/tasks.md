...
- [ ] 4.3 Operator confirms on live data — item 6 of the third pass in `verify-the-desk-in-one-sitting/runbook.md`: a thin contract opens with a book on the first snapshot, and a book that cannot be built leaves the chart and tape alive.
