...
- [ ] 2.1 После ближайшего фандинг-часа по 龙虾USDT: заряд виден в settled
      (PnL-док), сумма бьётся с бинанс-аппом.
- [ ] 2.2 Закрытые раунды пары в истории якорятся (нет вечного «reading»),
      повторное открытие вкладки не перечитывает пару с нуля.
- [ ] 2.3 Настройка группировки книги на 龙虾USDT переживает рестарт деска.
