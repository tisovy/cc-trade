...
- [ ] 4.3 Operator confirms on live data — step 10, «Тихий контракт открывается со стаканом», in `verify-the-desk-in-one-sitting/runbook.md`: a thin contract opens with a book on the first snapshot, and a book that cannot be built leaves the chart and tape alive.
