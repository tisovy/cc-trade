...
- [x] 1.1 Map the order book's three `resync` reasons to three codes in the
...
- [x] 2.1 In `recoverBook`, keep the bootstrap result and write its reason
...
- [x] 3.1 One journal, one story: a live chain broken once, then a rebuild that
...
- [x] 3.2 The service suite passes unchanged around it.
