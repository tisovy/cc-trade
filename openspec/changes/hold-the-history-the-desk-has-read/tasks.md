...
- [x] 7.3 Perform the opening read in the trading hook rather than in a panel: the dock mounts before the transport is usable, and a read issued there would be lost with nothing to re-arm it.
