# spot-request-accounting Specification

## Purpose

Charge Spot reads for their actual query scope and every physical retry so requests remain governed by their admission owner.
