# terminal-runtime-faults Specification

## Purpose

Terminate the main process after an unhandled fault with bounded safe diagnostics and no automatic trading side effects.
