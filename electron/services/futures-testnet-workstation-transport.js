...
export const createFuturesTestnetWorkstationReviewedTransport = () => Object.freeze({
    ...
    bootstrap: async ({ symbol, pair, interval, signal } = {}) => {
        ...
        const [
            ...
            weightedGet(FUTURES_TESTNET_WORKSTATION_WEIGHTS.DEPTH_1000, FUTURES_TESTNET_WORKSTATION_ROUTES.DEPTH, { symbol, limit: '1000' }, FUTURES_WORKSTATION_BODY_LIMITS.DEPTH, signal),
            weightedGet(FUTURES_TESTNET_WORKSTATION_WEIGHTS.KLINES_500, FUTURES_TESTNET_WORKSTATION_ROUTES.KLINES, { symbol, interval, limit: '500' }, FUTURES_WORKSTATION_BODY_LIMITS.KLINES, signal),
            weightedGet(FUTURES_TESTNET_WORKSTATION_WEIGHTS.MARK_KLINES_500, FUTURES_TESTNET_WORKSTATION_ROUTES.MARK_KLINES, { symbol, interval, limit: '500' }, FUTURES_WORKSTATION_BODY_LIMITS.KLINES, signal),
            weightedGet(FUTURES_TESTNET_WORKSTATION_WEIGHTS.INDEX_KLINES_500, FUTURES_TESTNET_WORKSTATION_ROUTES.INDEX_KLINES, { pair, interval, limit: '500' }, FUTURES_WORKSTATION_BODY_LIMITS.KLINES, signal),
            weightedGet(FUTURES_TESTNET_WORKSTATION_WEIGHTS.PREMIUM_INDEX_SYMBOL, FUTURES_TESTNET_WORKSTATION_ROUTES.PREMIUM_INDEX, { symbol }, FUTURES_WORKSTATION_BODY_LIMITS.HEADER, signal),
            weightedGet(FUTURES_TESTNET_WORKSTATION_WEIGHTS.TICKER_SYMBOL, FUTURES_TESTNET_WORKSTATION_ROUTES.TICKER, { symbol }, FUTURES_WORKSTATION_BODY_LIMITS.HEADER, signal),
        ]);
