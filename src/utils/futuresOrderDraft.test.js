...
describe('futuresOrderDraft', () => {
  ...
  it('converts exact half-percentage stops and rounds typed amounts to the nearest stop', () => {
    ...
    expect(calculateFuturesNotionalForPercent('1000', '8.5')).toBeNull()
    expect(calculateFuturesNotionalForPercent('1000', null)).toBeNull()
    expect(calculateFuturesNotionalForPercent('1000', true)).toBeNull()
