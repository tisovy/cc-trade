...
This project is indexed by GitNexus as **trade_ui_latest** (7599 symbols, 12876 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/trade_ui_latest/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/trade_ui_latest/context` | Codebase overview, check index freshness |
| `gitnexus://repo/trade_ui_latest/clusters` | All functional areas |
| `gitnexus://repo/trade_ui_latest/processes` | All execution flows |
| `gitnexus://repo/trade_ui_latest/process/{name}` | Step-by-step execution trace |
